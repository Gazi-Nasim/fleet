...
class Tauhid_model extends CI_Model
{
    ...
    public function getDriver()
    {
        ...
        // $this->db->select('admin.id, admin.name');
        // $this->db->from('admin');
        // $this->db->join('drivers', 'admin.id = drivers.admin_id');
        // $this->db->where('admin.role', 'driver');
        // $this->db->where('drivers.status', 'inactive');
    ...
    public function getBooking()
    {
        ...
        // return $this->db->select('bookings.*, IFNULL(admin.name, "") AS drivername, customers.name AS customername, vehicles.name AS vehiclename')
        //     ->from('bookings')
        //     ->join('admin', 'admin.id=bookings.driver_id', 'left')
        //     ->join('customers', 'bookings.customer_id=customers.id')
        //     ->join('vehicles', 'bookings.vehicle_id=vehicles.id')
        //     ->where("admin.role='driver'")
        //     ->get()->result();
